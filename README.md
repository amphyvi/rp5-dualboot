...
10. **Put the SD card into your Retroid Pocket 5** (or other device that can boot from it - we'll be assuming you're using your RP5 in this guide). Unintuitively, the SD card goes in upside down in the RP5.
